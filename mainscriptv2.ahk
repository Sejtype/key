...
if FileExist(configFile) {
    windowX1 := IniRead(configFile, "Coords", "windowX1", windowX1)
windowY1 := IniRead(configFile, "Coords", "windowY1", windowY1)
windowX2 := IniRead(configFile, "Coords", "windowX2", windowX2)
windowY2 := IniRead(configFile, "Coords", "windowY2", windowY2)
windowX3 := IniRead(configFile, "Coords", "windowX3", windowX3)
windowY3 := IniRead(configFile, "Coords", "windowY3", windowY3)
windowX4 := IniRead(configFile, "Coords", "windowX4", windowX4)
windowY4 := IniRead(configFile, "Coords", "windowY4", windowY4)
windowX5 := IniRead(configFile, "Coords", "windowX5", windowX5)
windowY5 := IniRead(configFile, "Coords", "windowY5", windowY5)
windowX6 := IniRead(configFile, "Coords", "windowX6", windowX5)
windowY6 := IniRead(configFile, "Coords", "windowY6", windowY5)
