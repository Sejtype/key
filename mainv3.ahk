...
remoteConfig := A_Temp "\\config.ini"
if !FileExist(remoteConfig) {
    MsgBox "Remote config file not found!"
    ExitApp
}

if FileExist(remoteConfig) {
    windowX1 := IniRead(remoteConfig, "Coords", "windowX1", windowX1)
windowY1 := IniRead(remoteConfig, "Coords", "windowY1", windowY1)
windowX2 := IniRead(remoteConfig, "Coords", "windowX2", windowX2)
windowY2 := IniRead(remoteConfig, "Coords", "windowY2", windowY2)
windowX3 := IniRead(remoteConfig, "Coords", "windowX3", windowX3)
windowY3 := IniRead(remoteConfig, "Coords", "windowY3", windowY3)
windowX4 := IniRead(remoteConfig, "Coords", "windowX4", windowX4)
windowY4 := IniRead(remoteConfig, "Coords", "windowY4", windowY4)
windowX5 := IniRead(remoteConfig, "Coords", "windowX5", windowX5)
windowY5 := IniRead(remoteConfig, "Coords", "windowY5", windowY5)
windowX6 := IniRead(remoteConfig, "Coords", "windowX6", windowX5)
windowY6 := IniRead(remoteConfig, "Coords", "windowY6", windowY5)
clickcooldown := IniRead(remoteConfig, "Times", "ClickCoolDown", DEFAULT_CLICKCOOLDOWN)
    cooldown := IniRead(remoteConfig, "Times", "FishTime", DEFAULT_COOLDOWN)
} else {
    clickcooldown := DEFAULT_CLICKCOOLDOWN
...
SetWindowCoords1(*) {
    global windowX1, windowY1, configFile
    MouseGetPos &x, &y
    windowX1 := x
    windowY1 := y
...
SetWindowCoords2(*) {
    global windowX2, windowY2, configFile
    MouseGetPos &x, &y
    windowX2 := x
    windowY2 := y
...
SetWindowCoords3(*) {
    global windowX3, windowY3, configFile
    MouseGetPos &x, &y
    windowX3 := x
    windowY3 := y
...
SetWindowCoords4(*) {
    global windowX4, windowY4, configFile
    MouseGetPos &x, &y
    windowX4 := x
    windowY4 := y
...
SetWindowCoords5(*) {
    global windowX5, windowY5, configFile
    MouseGetPos &x, &y
    windowX5 := x
    windowY5 := y
...
SetWindowCoords6(*) {
    global windowX6, windowY6, configFile
    MouseGetPos &x, &y
    windowX6 := x
    windowY6 := y
